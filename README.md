...
实现过程中的 **38 条踩坑记录**在 [`docs/bug-record.md`](docs/bug-record.md) —— 那份文档比这份 README 更能说明这个项目做了什么。
...
| `admin` | `admin123` | **管理员**。按设计只负责"人与店"：**员工管理**（`/api/staff` 增删改查、重置密码、启用停用）与**门店管理**（建店改店、启用停业）—— 2026-09-18 起都已实现。订单与定价写接口对他是 403，那是有意口径（2026-09-11 起） |
...
- [`docs/bug-record.md`](docs/bug-record.md) —— 38 条 bug 的现象 / 根因 / 修法，以及每轮"测试通过的功能"清单
